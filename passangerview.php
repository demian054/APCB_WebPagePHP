...
$passanger_view = NULL; // Initialize page object first

class cpassanger_view extends cpassanger {
	...
	// Page object name
	var $PageObjName = 'passanger_view';
	...
	function __construct() {
		...
		if (@$_GET["PASSANGER_ID"] <> "") {
			$this->RecKey["PASSANGER_ID"] = $_GET["PASSANGER_ID"];
			$KeyUrl .= "&amp;PASSANGER_ID=" . urlencode($this->RecKey["PASSANGER_ID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["PASSANGER_ID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["PASSANGER_ID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["PASSANGER_ID"] <> "") {
				...
				$this->RecKey["PASSANGER_ID"] = $this->PASSANGER_ID->QueryStringValue;
			} elseif (@$_POST["PASSANGER_ID"] <> "") {
				$this->PASSANGER_ID->setFormValue($_POST["PASSANGER_ID"]);
				$this->RecKey["PASSANGER_ID"] = $this->PASSANGER_ID->FormValue;
			} else {
				$sReturnUrl = "passangerlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "passangerlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "passangerlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($passanger_view)) $passanger_view = new cpassanger_view();

// Page init
$passanger_view->Page_Init();

// Page main
$passanger_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$passanger_view->Page_Render();
?>
...
var CurrentForm = fpassangerview = new ew_Form("fpassangerview", "view");

// Form_CustomValidate event
fpassangerview.Form_CustomValidate = 
...
fpassangerview.ValidateRequired = true;
<?php } else { ?>
fpassangerview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $passanger_view->ExportOptions->Render("body") ?>
<?php
	foreach ($passanger_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($passanger->Export == "") { ?>
...
<?php } ?>
<?php $passanger_view->ShowPageHeader(); ?>
<?php
$passanger_view->ShowMessage();
?>
<form name="fpassangerview" id="fpassangerview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($passanger_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $passanger_view->Token ?>">
<?php } ?>
...
<?php if ($passanger->PASSANGER_ID->Visible) { // PASSANGER_ID ?>
	<tr id="r_PASSANGER_ID">
		<td><span id="elh_passanger_PASSANGER_ID"><?php echo $passanger->PASSANGER_ID->FldCaption() ?></span></td>
		<td data-name="PASSANGER_ID"<?php echo $passanger->PASSANGER_ID->CellAttributes() ?>>
<span id="el_passanger_PASSANGER_ID">
<span<?php echo $passanger->PASSANGER_ID->ViewAttributes() ?>>
<?php echo $passanger->PASSANGER_ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($passanger->CODE->Visible) { // CODE ?>
	<tr id="r_CODE">
		<td><span id="elh_passanger_CODE"><?php echo $passanger->CODE->FldCaption() ?></span></td>
...
<?php echo $passanger->CODE->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($passanger->FIRSTNAME->Visible) { // FIRSTNAME ?>
	<tr id="r_FIRSTNAME">
		<td><span id="elh_passanger_FIRSTNAME"><?php echo $passanger->FIRSTNAME->FldCaption() ?></span></td>
...
<?php echo $passanger->FIRSTNAME->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($passanger->SECONDNAME->Visible) { // SECONDNAME ?>
	<tr id="r_SECONDNAME">
		<td><span id="elh_passanger_SECONDNAME"><?php echo $passanger->SECONDNAME->FldCaption() ?></span></td>
...
<?php echo $passanger->SECONDNAME->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($passanger->LASTNAME->Visible) { // LASTNAME ?>
	<tr id="r_LASTNAME">
		<td><span id="elh_passanger_LASTNAME"><?php echo $passanger->LASTNAME->FldCaption() ?></span></td>
...
<?php echo $passanger->LASTNAME->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($passanger->SURNAME->Visible) { // SURNAME ?>
	<tr id="r_SURNAME">
		<td><span id="elh_passanger_SURNAME"><?php echo $passanger->SURNAME->FldCaption() ?></span></td>
...
<?php echo $passanger->SURNAME->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($passanger->MAIL->Visible) { // MAIL ?>
	<tr id="r_MAIL">
		<td><span id="elh_passanger_MAIL"><?php echo $passanger->MAIL->FldCaption() ?></span></td>
...
<?php echo $passanger->MAIL->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($passanger->PASSANGER_TYPE_ID->Visible) { // PASSANGER_TYPE_ID ?>
	<tr id="r_PASSANGER_TYPE_ID">
		<td><span id="elh_passanger_PASSANGER_TYPE_ID"><?php echo $passanger->PASSANGER_TYPE_ID->FldCaption() ?></span></td>
...
<?php echo $passanger->PASSANGER_TYPE_ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($passanger->USER_ID->Visible) { // USER_ID ?>
	<tr id="r_USER_ID">
		<td><span id="elh_passanger_USER_ID"><?php echo $passanger->USER_ID->FldCaption() ?></span></td>
...
<?php echo $passanger->USER_ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
