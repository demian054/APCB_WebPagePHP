...
fuser_levelsview.ValidateRequired = true;
<?php } else { ?>
fuser_levelsview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($user_levels->USER_LEVEL_ID->Visible) { // USER_LEVEL_ID ?>
	<tr id="r_USER_LEVEL_ID">
		<td><span id="elh_user_levels_USER_LEVEL_ID"><?php echo $user_levels->USER_LEVEL_ID->FldCaption() ?></span></td>
...
<?php if ($user_levels->DESCRIPTION->Visible) { // DESCRIPTION ?>
	<tr id="r_DESCRIPTION">
		<td><span id="elh_user_levels_DESCRIPTION"><?php echo $user_levels->DESCRIPTION->FldCaption() ?></span></td>
		<td data-name="DESCRIPTION"<?php echo $user_levels->DESCRIPTION->CellAttributes() ?>>
<span id="el_user_levels_DESCRIPTION">
<span<?php echo $user_levels->DESCRIPTION->ViewAttributes() ?>>
<?php echo $user_levels->DESCRIPTION->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
