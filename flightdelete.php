...
var CurrentForm = fflightdelete = new ew_Form("fflightdelete", "delete");
...
?>
<form name="fflightdelete" id="fflightdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($flight_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $flight_delete->Token ?>">
<?php } ?>
...
<?php if ($flight->FLIGHT_ID->Visible) { // FLIGHT_ID ?>
		<th><span id="elh_flight_FLIGHT_ID" class="flight_FLIGHT_ID"><?php echo $flight->FLIGHT_ID->FldCaption() ?></span></th>
<?php } ?>
<?php if ($flight->CODE->Visible) { // CODE ?>
		<th><span id="elh_flight_CODE" class="flight_CODE"><?php echo $flight->CODE->FldCaption() ?></span></th>
<?php } ?>
<?php if ($flight->DESCRIPTION->Visible) { // DESCRIPTION ?>
		<th><span id="elh_flight_DESCRIPTION" class="flight_DESCRIPTION"><?php echo $flight->DESCRIPTION->FldCaption() ?></span></th>
<?php } ?>
<?php if ($flight->AIRPLANE_ID->Visible) { // AIRPLANE_ID ?>
		<th><span id="elh_flight_AIRPLANE_ID" class="flight_AIRPLANE_ID"><?php echo $flight->AIRPLANE_ID->FldCaption() ?></span></th>
<?php } ?>
<?php if ($flight->AIR_PORT_ID_DEPARTURE->Visible) { // AIR_PORT_ID_DEPARTURE ?>
		<th><span id="elh_flight_AIR_PORT_ID_DEPARTURE" class="flight_AIR_PORT_ID_DEPARTURE"><?php echo $flight->AIR_PORT_ID_DEPARTURE->FldCaption() ?></span></th>
<?php } ?>
<?php if ($flight->AIR_PORT_ID_ARRIVAL->Visible) { // AIR_PORT_ID_ARRIVAL ?>
		<th><span id="elh_flight_AIR_PORT_ID_ARRIVAL" class="flight_AIR_PORT_ID_ARRIVAL"><?php echo $flight->AIR_PORT_ID_ARRIVAL->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($flight->FLIGHT_ID->Visible) { // FLIGHT_ID ?>
		<td<?php echo $flight->FLIGHT_ID->CellAttributes() ?>>
<span id="el<?php echo $flight_delete->RowCnt ?>_flight_FLIGHT_ID" class="flight_FLIGHT_ID">
...
<?php } ?>
<?php if ($flight->CODE->Visible) { // CODE ?>
		<td<?php echo $flight->CODE->CellAttributes() ?>>
<span id="el<?php echo $flight_delete->RowCnt ?>_flight_CODE" class="flight_CODE">
...
<?php } ?>
<?php if ($flight->DESCRIPTION->Visible) { // DESCRIPTION ?>
		<td<?php echo $flight->DESCRIPTION->CellAttributes() ?>>
<span id="el<?php echo $flight_delete->RowCnt ?>_flight_DESCRIPTION" class="flight_DESCRIPTION">
...
<?php } ?>
<?php if ($flight->AIRPLANE_ID->Visible) { // AIRPLANE_ID ?>
		<td<?php echo $flight->AIRPLANE_ID->CellAttributes() ?>>
<span id="el<?php echo $flight_delete->RowCnt ?>_flight_AIRPLANE_ID" class="flight_AIRPLANE_ID">
...
<?php } ?>
<?php if ($flight->AIR_PORT_ID_DEPARTURE->Visible) { // AIR_PORT_ID_DEPARTURE ?>
		<td<?php echo $flight->AIR_PORT_ID_DEPARTURE->CellAttributes() ?>>
<span id="el<?php echo $flight_delete->RowCnt ?>_flight_AIR_PORT_ID_DEPARTURE" class="flight_AIR_PORT_ID_DEPARTURE">
...
<?php } ?>
<?php if ($flight->AIR_PORT_ID_ARRIVAL->Visible) { // AIR_PORT_ID_ARRIVAL ?>
		<td<?php echo $flight->AIR_PORT_ID_ARRIVAL->CellAttributes() ?>>
<span id="el<?php echo $flight_delete->RowCnt ?>_flight_AIR_PORT_ID_ARRIVAL" class="flight_AIR_PORT_ID_ARRIVAL">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $flight_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fflightdelete.Init();
