...
class cuser_levels extends cTable {
	...
	function __construct() {
		...
		// DESCRIPTION
		$this->DESCRIPTION = new cField('user_levels', 'user_levels', 'x_DESCRIPTION', 'DESCRIPTION', '`DESCRIPTION`', '`DESCRIPTION`', 200, -1, FALSE, '`DESCRIPTION`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		if (in_array($this->USER_LEVEL_ID->CurrentValue, array(-2,-1,0))) $this->DESCRIPTION->ReadOnly = TRUE;
