...
$bank_account_edit = NULL; // Initialize page object first

class cbank_account_edit extends cbank_account {
	...
	// Page object name
	var $PageObjName = 'bank_account_edit';
	...
	function Page_Main() {
		...
		if ($this->BANK_ACCOUNT_ID->CurrentValue == "")
			$this->Page_Terminate("bank_accountlist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// ACCOUNT_NUMBER
			$this->ACCOUNT_NUMBER->SetDbValueDef($rsnew, $this->ACCOUNT_NUMBER->CurrentValue, 0, $this->ACCOUNT_NUMBER->ReadOnly);
...
// Create page object
if (!isset($bank_account_edit)) $bank_account_edit = new cbank_account_edit();

// Page init
$bank_account_edit->Page_Init();

// Page main
$bank_account_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$bank_account_edit->Page_Render();
?>
...
var CurrentForm = fbank_accountedit = new ew_Form("fbank_accountedit", "edit");

// Validate form
fbank_accountedit.Validate = function() {
...
fbank_accountedit.Form_CustomValidate = 
...
fbank_accountedit.ValidateRequired = true;
<?php } else { ?>
fbank_accountedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fbank_accountedit.Lists["x_BANK_ID"] = {"LinkField":"x_BANK_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_DESCRIPTION","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fbank_accountedit.Lists["x_ACTIVE"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fbank_accountedit.Lists["x_ACTIVE"].Options = <?php echo json_encode($bank_account->ACTIVE->Options()) ?>;
...
<?php $bank_account_edit->ShowPageHeader(); ?>
<?php
$bank_account_edit->ShowMessage();
?>
<form name="fbank_accountedit" id="fbank_accountedit" class="<?php echo $bank_account_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($bank_account_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $bank_account_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="bank_account" data-field="x_BANK_ACCOUNT_ID" name="x_BANK_ACCOUNT_ID" id="x_BANK_ACCOUNT_ID" value="<?php echo ew_HtmlEncode($bank_account->BANK_ACCOUNT_ID->CurrentValue) ?>">
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $bank_account_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fbank_accountedit.Init();
</script>
<?php
$bank_account_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$bank_account_edit->Page_Terminate();
?>
