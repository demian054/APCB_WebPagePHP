...
<?php if ($user->SECONDNAME->Visible) { // SECONDNAME ?>
	<tr id="r_SECONDNAME">
		<td><span id="elh_user_SECONDNAME"><?php echo $user->SECONDNAME->FldCaption() ?></span></td>
...
<?php echo $user->SECONDNAME->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
