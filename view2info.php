...
class cview2 extends cTable {
	...
	function __construct() {
		...
		// USER_ID
		$this->USER_ID = new cField('view2', 'view2', 'x_USER_ID', 'USER_ID', '`USER_ID`', '`USER_ID`', 3, -1, FALSE, '`USER_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->USER_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['USER_ID'] = &$this->USER_ID;

		// CODE
		$this->CODE = new cField('view2', 'view2', 'x_CODE', 'CODE', '`CODE`', '`CODE`', 200, -1, FALSE, '`CODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['CODE'] = &$this->CODE;

		// PASS
		$this->PASS = new cField('view2', 'view2', 'x_PASS', 'PASS', '`PASS`', '`PASS`', 200, -1, FALSE, '`PASS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SECONDNAME
		$this->SECONDNAME = new cField('view2', 'view2', 'x_SECONDNAME', 'SECONDNAME', '`SECONDNAME`', '`SECONDNAME`', 200, -1, FALSE, '`SECONDNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SURNAME
		$this->SURNAME = new cField('view2', 'view2', 'x_SURNAME', 'SURNAME', '`SURNAME`', '`SURNAME`', 200, -1, FALSE, '`SURNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['SURNAME'] = &$this->SURNAME;

		// MAIL
		$this->MAIL = new cField('view2', 'view2', 'x_MAIL', 'MAIL', '`MAIL`', '`MAIL`', 200, -1, FALSE, '`MAIL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['MAIL'] = &$this->MAIL;

		// USER_ACT
		$this->USER_ACT = new cField('view2', 'view2', 'x_USER_ACT', 'USER_ACT', '`USER_ACT`', '`USER_ACT`', 16, -1, FALSE, '`USER_ACT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USER_ACT->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['USER_ACT'] = &$this->USER_ACT;

		// USER_LEVEL_ID
		$this->USER_LEVEL_ID = new cField('view2', 'view2', 'x_USER_LEVEL_ID', 'USER_LEVEL_ID', '`USER_LEVEL_ID`', '`USER_LEVEL_ID`', 3, -1, FALSE, '`USER_LEVEL_ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		...
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `view2`";
