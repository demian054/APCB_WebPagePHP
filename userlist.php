...
class cuser_list extends cuser {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->USER_ACT->AdvancedSearch->ToJSON(), ","); // Field USER_ACT
	...
	function RestoreFilterList() {
		...
		// Field USER_ACT
		$this->USER_ACT->AdvancedSearch->SearchValue = @$filter["x_USER_ACT"];
		$this->USER_ACT->AdvancedSearch->SearchOperator = @$filter["z_USER_ACT"];
		$this->USER_ACT->AdvancedSearch->SearchCondition = @$filter["v_USER_ACT"];
		$this->USER_ACT->AdvancedSearch->SearchValue2 = @$filter["y_USER_ACT"];
		$this->USER_ACT->AdvancedSearch->SearchOperator2 = @$filter["w_USER_ACT"];
		$this->USER_ACT->AdvancedSearch->Save();
...
<?php if ($user->FIRSTNAME->Visible) { // FIRSTNAME ?>
	...
	<?php } else { ?>
		<th data-name="FIRSTNAME"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->FIRSTNAME) ?>',2);"><div id="elh_user_FIRSTNAME" class="user_FIRSTNAME">
...
<?php if ($user->SECONDNAME->Visible) { // SECONDNAME ?>
	<?php if ($user->SortUrl($user->SECONDNAME) == "") { ?>
		<th data-name="SECONDNAME"><div id="elh_user_SECONDNAME" class="user_SECONDNAME"><div class="ewTableHeaderCaption"><?php echo $user->SECONDNAME->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="SECONDNAME"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->SECONDNAME) ?>',2);"><div id="elh_user_SECONDNAME" class="user_SECONDNAME">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->SECONDNAME->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user->SECONDNAME->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->SECONDNAME->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($user->LASTNAME->Visible) { // LASTNAME ?>
	...
	<?php } else { ?>
		<th data-name="LASTNAME"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->LASTNAME) ?>',2);"><div id="elh_user_LASTNAME" class="user_LASTNAME">
...
<?php if ($user->SURNAME->Visible) { // SURNAME ?>
	...
	<?php } else { ?>
		<th data-name="SURNAME"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->SURNAME) ?>',2);"><div id="elh_user_SURNAME" class="user_SURNAME">
...
<?php if ($user->MAIL->Visible) { // MAIL ?>
	<?php if ($user->SortUrl($user->MAIL) == "") { ?>
		<th data-name="MAIL"><div id="elh_user_MAIL" class="user_MAIL"><div class="ewTableHeaderCaption"><?php echo $user->MAIL->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="MAIL"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->MAIL) ?>',2);"><div id="elh_user_MAIL" class="user_MAIL">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->MAIL->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user->MAIL->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->MAIL->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<a id="<?php echo $user_list->PageObjName . "_row_" . $user_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($user->SECONDNAME->Visible) { // SECONDNAME ?>
		<td data-name="SECONDNAME"<?php echo $user->SECONDNAME->CellAttributes() ?>>
<span id="el<?php echo $user_list->RowCnt ?>_user_SECONDNAME" class="user_SECONDNAME">
<span<?php echo $user->SECONDNAME->ViewAttributes() ?>>
<?php echo $user->SECONDNAME->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($user->LASTNAME->Visible) { // LASTNAME ?>
...
<?php echo $user->SURNAME->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($user->MAIL->Visible) { // MAIL ?>
		<td data-name="MAIL"<?php echo $user->MAIL->CellAttributes() ?>>
<span id="el<?php echo $user_list->RowCnt ?>_user_MAIL" class="user_MAIL">
<span<?php echo $user->MAIL->ViewAttributes() ?>>
<?php echo $user->MAIL->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
...
<option value="15"<?php if ($user_list->DisplayRecs == 15) { ?> selected="selected"<?php } ?>>15</option>
<option value="50"<?php if ($user_list->DisplayRecs == 50) { ?> selected="selected"<?php } ?>>50</option>
<option value="ALL"<?php if ($user->getRecordsPerPage() == -1) { ?> selected="selected"<?php } ?>><?php echo $Language->Phrase("AllRecords") ?></option>
</select>
</div>
<?php } ?>
</form>
