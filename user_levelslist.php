...
class cuser_levels_list extends cuser_levels {
	...
	function RenderRow() {
		...
		if ($Security->GetUserLevelName($this->USER_LEVEL_ID->CurrentValue) <> "") $this->DESCRIPTION->ViewValue = $Security->GetUserLevelName($this->USER_LEVEL_ID->CurrentValue);
...
<?php if ($user_levels->USER_LEVEL_ID->Visible) { // USER_LEVEL_ID ?>
	...
	<?php } else { ?>
		<th data-name="USER_LEVEL_ID"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user_levels->SortUrl($user_levels->USER_LEVEL_ID) ?>',2);"><div id="elh_user_levels_USER_LEVEL_ID" class="user_levels_USER_LEVEL_ID">
	...
	<?php } ?>
<?php } ?>		
<?php if ($user_levels->DESCRIPTION->Visible) { // DESCRIPTION ?>
	<?php if ($user_levels->SortUrl($user_levels->DESCRIPTION) == "") { ?>
		<th data-name="DESCRIPTION"><div id="elh_user_levels_DESCRIPTION" class="user_levels_DESCRIPTION"><div class="ewTableHeaderCaption"><?php echo $user_levels->DESCRIPTION->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="DESCRIPTION"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user_levels->SortUrl($user_levels->DESCRIPTION) ?>',2);"><div id="elh_user_levels_DESCRIPTION" class="user_levels_DESCRIPTION">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user_levels->DESCRIPTION->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user_levels->DESCRIPTION->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user_levels->DESCRIPTION->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<a id="<?php echo $user_levels_list->PageObjName . "_row_" . $user_levels_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($user_levels->DESCRIPTION->Visible) { // DESCRIPTION ?>
		<td data-name="DESCRIPTION"<?php echo $user_levels->DESCRIPTION->CellAttributes() ?>>
<span id="el<?php echo $user_levels_list->RowCnt ?>_user_levels_DESCRIPTION" class="user_levels_DESCRIPTION">
<span<?php echo $user_levels->DESCRIPTION->ViewAttributes() ?>>
<?php echo $user_levels->DESCRIPTION->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
...
<option value="15"<?php if ($user_levels_list->DisplayRecs == 15) { ?> selected="selected"<?php } ?>>15</option>
<option value="50"<?php if ($user_levels_list->DisplayRecs == 50) { ?> selected="selected"<?php } ?>>50</option>
<option value="ALL"<?php if ($user_levels->getRecordsPerPage() == -1) { ?> selected="selected"<?php } ?>><?php echo $Language->Phrase("AllRecords") ?></option>
</select>
</div>
<?php } ?>
</form>
