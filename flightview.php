...
class cflight_view extends cflight {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["FLIGHT_ID"] <> "") {
			$this->RecKey["FLIGHT_ID"] = $_GET["FLIGHT_ID"];
			$KeyUrl .= "&amp;FLIGHT_ID=" . urlencode($this->RecKey["FLIGHT_ID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["FLIGHT_ID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["FLIGHT_ID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["FLIGHT_ID"] <> "") {
				...
				$this->RecKey["FLIGHT_ID"] = $this->FLIGHT_ID->QueryStringValue;
			} elseif (@$_POST["FLIGHT_ID"] <> "") {
				$this->FLIGHT_ID->setFormValue($_POST["FLIGHT_ID"]);
				$this->RecKey["FLIGHT_ID"] = $this->FLIGHT_ID->FormValue;
			} else {
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_flight\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_flight',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fflightview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
var CurrentForm = fflightview = new ew_Form("fflightview", "view");
...
?>
<form name="fflightview" id="fflightview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($flight_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $flight_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="flight">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($flight->FLIGHT_ID->Visible) { // FLIGHT_ID ?>
	<tr id="r_FLIGHT_ID">
		<td><span id="elh_flight_FLIGHT_ID"><?php echo $flight->FLIGHT_ID->FldCaption() ?></span></td>
...
<?php echo $flight->FLIGHT_ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($flight->DESCRIPTION->Visible) { // DESCRIPTION ?>
	<tr id="r_DESCRIPTION">
		<td><span id="elh_flight_DESCRIPTION"><?php echo $flight->DESCRIPTION->FldCaption() ?></span></td>
...
<?php echo $flight->DESCRIPTION->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($flight->AIRPLANE_ID->Visible) { // AIRPLANE_ID ?>
	<tr id="r_AIRPLANE_ID">
		<td><span id="elh_flight_AIRPLANE_ID"><?php echo $flight->AIRPLANE_ID->FldCaption() ?></span></td>
...
<?php echo $flight->AIRPLANE_ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($flight->AIR_PORT_ID_DEPARTURE->Visible) { // AIR_PORT_ID_DEPARTURE ?>
	<tr id="r_AIR_PORT_ID_DEPARTURE">
		<td><span id="elh_flight_AIR_PORT_ID_DEPARTURE"><?php echo $flight->AIR_PORT_ID_DEPARTURE->FldCaption() ?></span></td>
...
<?php echo $flight->AIR_PORT_ID_DEPARTURE->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($flight->AIR_PORT_ID_ARRIVAL->Visible) { // AIR_PORT_ID_ARRIVAL ?>
	<tr id="r_AIR_PORT_ID_ARRIVAL">
		<td><span id="elh_flight_AIR_PORT_ID_ARRIVAL"><?php echo $flight->AIR_PORT_ID_ARRIVAL->FldCaption() ?></span></td>
...
<?php echo $flight->AIR_PORT_ID_ARRIVAL->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
