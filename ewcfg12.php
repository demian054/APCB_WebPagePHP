...
define("EW_PROJECT_NAME", "Aero", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{B2F6402D-7C0A-4760-82AD-045088CEBA18}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'RqL8FSWoytSprUj3', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/Aero.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "aero", "qs" => "`", "qe" => "`");
...
$EW_LANGUAGE_FILE[] = array("es", "", "espanol.xml");
...
// Security
define("EW_ADMIN_USER_NAME", "root", TRUE); // Administrator user name
...
@define("EW_USER_LEVEL_NAME_FIELD", "`DESCRIPTION`", TRUE);
...
@define("EW_USER_LEVEL_PRIV_PRIV_FIELD", "`PERMISION`", TRUE);
...
define("EW_UPLOAD_DEST_PATH", "/UploadFiles/", TRUE); // Upload destination path (relative to app root)
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "txt,xls,xlsx", TRUE); // Allowed file extensions
